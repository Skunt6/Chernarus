...
start "DayZ Server" /min "DayZServer_x64.exe" -config=%serverConfig% -port=2302 "-profiles=config" "-mod=@QuickMoveItemsByCategory;@Survivor Animations;@DayZ Horse;@Winter Chernarus V2;@Namalsk Survival;@Fast Travel;@Techs 4x4 All Terrain Vehicles;@CJ187-LootChest;@Custom Keycards;@Code Lock;@BaseBuildingPlus;@BBPWallpaperBeerGarden;@BBPItemPack;@PvZmoD_TheDarkHorde;@KillAssets;@FlipTransport;@DrugsPLUS;@dzr_notes;@Juggernaut Armor;@BulletStacksPlusPlusEnhanced;@GunnerTruckOshkosh;@TangoMedievalPack;@CannabisPlus;@DayZ-Dog;@Community-Online-Tools;@DayZ Editor Loader;@DayZOresAndGems;@MMG - Mightys Military Gear;@MMG Base Storage;@SNAFU Weapons;@DayZ-Expansion-Licensed;@DayZ-Expansion-Bundle;@InventoryInCar;@Dabs Framework;@CF;@Natures Weavers;" -cpuCount=%serverCPU% -dologs -adminlog -netlog -freezecheck
