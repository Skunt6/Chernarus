...
start "DayZ Server" /min "DayZServer_x64.exe" -config=%serverConfig% -port=2302 "-profiles=config" "-mod=@PvZmoD_TheDarkHorde;@KillAssets;@FlipTransport;@Inventory Move Sounds;@ViewInventoryAnimation;@TF-FuelPump;@Gas-Pump-Refueling;@DrugsPLUS;@dzr_notes;@InventoryPlusPlus;@Juggernaut Armor;@DBN_FordRaptor_Scorpio;@BulletStacksPlusPlusEnhanced;@TangoMedievalPack;@CannabisPlus;@DayZ-Dog;@dbo_raptors;@Community-Online-Tools;@Unlimited Stamina;@DayZ Editor Loader;@DayZOresAndGems;@DayZ-Expansion-Bundle;@MMG - Mightys Military Gear;@SNAFU Weapons;@DayZ-Expansion-Licensed;@Furniture;@InventoryInCar;@Dabs Framework;@CF;" -cpuCount=%serverCPU% -dologs -adminlog -netlog -freezecheck